...
@section('content')
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-12">
                <a class="btn btn-primary" href="{{route('products.create')}}"><i class="bi bi-bag-plus-fill"></i>
            ...
            <table class="table table-striped " style="vertical-align: baseline;text-align: center">
                ...
                @foreach($products as $key => $product)
                    <tr>
                        ...
                        <td>
                            <a style="margin: 5px" href="{{ route('products.edit', $product->id) }}"><i class="bi bi-pencil-fill  ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <a style="" href="{{ route('products.delete', $product->id) }}"
                               onclick="return confirm('Bạn chắc chắn muốn xóa san pham: {{ $product->productName }}' )"><i
                                    class="bi bi-trash  ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
