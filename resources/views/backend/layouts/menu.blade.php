        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                    <li class="active">
{{--                        <a href="{{route('customers.index')}}"> Danh sach khach hang </a>--}}
                    </li>
                    <li>
{{--                        <a href="{{route('productlines.index')}}"> Dong san pham </a>--}}
                    </li>
                </ul>
            </li>
...
{{--                    </div>--}}
                ...
                <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                    <li>
                        <a href="{{ route('orders.list') }}"> Order </a>
                    </li>
{{--                    <li>--}}
...
{{--            </li>--}}
            ...
            <li class="menu">
                <a href="{{ route('products.list') }}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-target"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="6"></circle><circle cx="12" cy="12" r="2"></circle></svg>
                        <span>List Prodcut </span>
                    </div>
                </a>
            </li>

            <li class="menu">
                <a href="{{ route('productlines.index') }}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
